...
const App = () => {
  return (
    <>
      ...
      <Firstname.Provider value={"Nimisha"}>
        <Lastname.Provider value={"Badiyani"}>
...
1. you dont have to create index file when you are using context
2. always use jsx element when you are using context
3. give proper name to your child component
